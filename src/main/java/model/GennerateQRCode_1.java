 ...
 * @author qivub
 */
public class GennerateQRCode_1 {
    ...
    public static void createQRCode (String secretKey, String accountName) {
        
        String otpAuthURL = String.format("otpauth://totp/%s?secret=%s", accountName, secretKey);
